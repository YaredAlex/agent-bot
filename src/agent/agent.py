...
class AssistantAgent:
    ...
    def _build_graph(self):
        ...
        self.builder.add_conditional_edges("assitant",tools_condition)
...
for chunk in agent.stream({"messages": "Hello there, did you know about GPT"}, config, stream_mode="values"):
